        ...
        <div style={{
          ...
          <div style={{
            ...
            <p style={{ fontSize: '14px', lineHeight: '1.6', color: 'var(--on-surface-variant, #49454f)', margin: 0 }}>
              {lang === 'id' 
                ? `Versi baru (${updateInfo.latest_version}) telah dirilis. Versi Anda saat ini adalah 1.3.0.`
                : `A new version (${updateInfo.latest_version}) is available. Your current version is 1.3.0.`}
            </p>
